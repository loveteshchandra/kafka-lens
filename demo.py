...
def print_config_example():
    ...
    print()
    print("```yaml")
    print("# Static Broker Configuration")
    print("bootstrap_servers: \"localhost:9092\"")
    print()
    print("# Optional: Cloud Provider Configuration")
    print("# cluster_arn: \"arn:...:kafka:...:cluster/...\"")
    print("# cloud_region: \"us-west-2\"")
    print("# cloud_profile: \"default\"")
    print()
...
def print_features():
    ...
    print("  • ☁️  Cloud cluster support with automatic broker discovery")
